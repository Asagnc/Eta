                            ...
                            JSONObject()
                                ...
                                .put(
                                    ...
                                    JSONObject()
                                        ...
                                        .put("description", "android uses the native Android shell with BusyBox applets when available. linux uses the Linux environment selected in Eta settings. Default android.")
                                )
                                .put(
                                    "command",
                                    JSONObject()
